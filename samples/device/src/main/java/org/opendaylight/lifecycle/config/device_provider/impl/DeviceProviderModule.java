 ...
 */
package org.opendaylight.lifecycle.config.device_provider.impl;
...
import org.opendaylight.lifecycle.samples.device.DeviceProvider;
import org.opendaylight.yang.gen.v1.urn.opendaylight.lifecycle.rev140714.NetworkElementTypeContext;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.lifecycle.samples.device.rev140714.Devices;
...
public class DeviceProviderModule extends AbstractDeviceProviderModule {
    ...
    private RoutedRpcRegistration<LifecycleSynchronizationService> rpcReg = null;
    ...
    public AutoCloseable createInstance() {
        ...
        rpcReg = getRpcRegistryDependency().addRoutedRpcImplementation(LifecycleSynchronizationService.class, provider);
        ...
        final InstanceIdentifier<Devices> path = InstanceIdentifier.builder(Devices.class).build();
        dataReg = getDataBrokerDependency().registerDataChangeListener(LogicalDatastoreType.CONFIGURATION, path,
                provider, DataChangeScope.ONE);
